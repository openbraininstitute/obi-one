    ...
    if file_extension not in ALLOWED_EXTENSIONS:
        raise HTTPException(
            ...
            detail={
                "code": ApiErrorCode.BAD_REQUEST,
                "detail": (
                    f"Invalid file extension '{file_extension}'. Must be one of "
                    f"{ALLOWED_EXT_STR}"
...
TEMPLATE = {"data": [{"id": "00a0c678-1bce-40fa-a28a-2bc44ff36f43",
   ...
   "measurement_kinds": [{"structural_domain": "axon",
    ...
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "raw",
       "unit": "μm",
       "value": 574.7376134395599}],
     "pref_label": "total_length"},
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "raw",
       "unit": "μm²",
       "value": 2083.9089844782807}],
     "pref_label": "total_area"},
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "raw",
       "unit": "μm³",
       "value": 786.4245895828037}],
     "pref_label": "total_volume"},
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "minimum",
       "unit": "μm",
       "value": 1.3708171844482422},
      ...
      {"name": "standard_deviation",
       "unit": "μm",
       "value": 10.971337931832881}],
     "pref_label": "section_lengths"},
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "minimum",
       "unit": "μm",
       "value": 3.0071189403533936},
    ...
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "minimum",
      ...
      {"name": "standard_deviation",
       "unit": "μm",
       "value": 0.11913148623554351}],
     "pref_label": "partition_asymmetry_length"},
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "minimum",
       "unit": "dimensionless",
       "value": 0.6121212244033813},
    ...
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "minimum",
      ...
      {"name": "standard_deviation",
       "unit": "μm³",
       "value": 49.988002414361766}],
     "pref_label": "section_volumes"},
    {"structural_domain": "basal_dendrite",
     "measurement_items": [{"name": "minimum",
       "unit": "μm²",
       "value": 4.523149450881758},
    ...
    {"structural_domain": "soma",
     "measurement_items": [{"name": "raw",
       "unit": "μm²",
       "value": 1218.140871757005}],
     "pref_label": "soma_surface_area"},
    {"structural_domain": "soma",
     "measurement_items": [{"name": "raw",
       "unit": "μm",
       "value": 9.845637133329614}],
