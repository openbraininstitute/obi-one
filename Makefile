...
check-deps:  ## Check that the dependencies in the existing lock file are valid, and that entitysdk is at the latest version. Temp removed: --upgrade-package entitysdk
	uv lock --locked 
