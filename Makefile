...
pip-audit:
	uv export --format=requirements.txt --no-hashes --group dev --extra connectivity > requirements.txt
	uv run --group audit pip-audit -r requirements.txt --progress-spinner off -f json -o pip-audit-output.json
