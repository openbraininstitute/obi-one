...
class Block:
    field_A: int | list[int] = Field(json_schema_extra={"ui_element": UIElement.INT_PARAMETER_SWEEP, ...})
    field_B: float | list[float] = Field(json_schema_extra={"ui_element": UIElement.INT_PARAMETER_SWEEP, ...})
```
...
class Block:
    field_A: int | list[int] = Field(json_schema_extra={"ui_element": UIElement.INT_PARAMETER_SWEEP, ...})
    field_B: int | list[int] = Field(json_schema_extra={"ui_element": UIElement.INT_PARAMETER_SWEEP, ...})
...
class Block:
    field_A: int | list[int] = Field(json_schema_extra={"ui_element": UIElement.INT_PARAMETER_SWEEP, ...})
    field_B: float | list[float] = Field(json_schema_extra={"ui_element": UIElement.FLOAT_PARAMETER_SWEEP, ...})
```
