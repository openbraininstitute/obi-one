...
ALL_NEURON_SETS_REFERENCE_UNION = (
    ATOMIC_ALL_NEURON_SETS_REFERENCE_UNION | CombinedBiophysicalNeuronSetReference
)
...
VIRTUAL_NEURON_SETS_REFERENCE_UNION = (
    ATOMIC_VIRTUAL_NEURON_SETS_REFERENCE_UNION | CombinedBiophysicalNeuronSetReference
)
POINT_NEURON_SETS_REFERENCE_UNION = (
    ATOMIC_POINT_NEURON_SETS_REFERENCE_UNION | CombinedBiophysicalNeuronSetReference
)
NON_VIRTUAL_NEURON_SETS_REFERENCE_UNION = (
    BIOPHYSICAL_NEURON_SETS_REFERENCE_UNION | POINT_NEURON_SETS_REFERENCE_UNION
)
...
POINT_NEURON_SETS_REFERENCE_TYPES = (
    ATOMIC_POINT_NEURON_SETS_REFERENCE_TYPES + COMBINED_BIOPHYSICAL_NEURON_SETS_REFERENCE_TYPES
)

VIRTUAL_NEURON_SETS_REFERENCE_TYPES = (
    ATOMIC_VIRTUAL_NEURON_SETS_REFERENCE_TYPES + COMBINED_BIOPHYSICAL_NEURON_SETS_REFERENCE_TYPES
)

NON_VIRTUAL_NEURON_SETS_REFERENCE_TYPES = (
    BIOPHYSICAL_NEURON_SETS_REFERENCE_TYPES + POINT_NEURON_SETS_REFERENCE_TYPES
)
