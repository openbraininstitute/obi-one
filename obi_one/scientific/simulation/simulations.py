...
class SimulationsForm(Form):
    ...
    class Initialize(Block):
        ...
        simulation_length: Annotated[NonNegativeFloat, Field(le=_MAX_SIMULATION_LENGTH_MILLISCONDS)] | Annotated[list[Annotated[NonNegativeFloat, Field(le=_MAX_SIMULATION_LENGTH_MILLISCONDS)]], Field(min_length=1)] = Field(default=1000.0, title="Duration", description="Simulation length in milliseconds (ms).", units="ms")
