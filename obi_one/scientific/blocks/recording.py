...
from neuroagent.backend.src.neuroagent.tools.autogenerated_types.obione import TimestampsReference
...
class Recording(Block, ABC):
    neuron_set: BiophysicalNeuronSetReference | PointNeuronSetReference | TimestampsReference | None = Field(
        ...
        json_schema_extra={
            ...
            SchemaKey.REFERENCE_TYPES: [BiophysicalNeuronSetReference.__type__, PointNeuronSetReference.__type__, TimestampsReference.__type__],
        },
    )
