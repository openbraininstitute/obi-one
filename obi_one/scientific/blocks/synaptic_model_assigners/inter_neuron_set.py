...
class InterNeuronSetSynapticModelAssigner(SynapseModelAssigner):
    ...
    def validate(self, circuit: Circuit) -> None:
        ...
        specified_target = self.targeted_neuron_set.block.node_population
    ...
    def edge_indices(self, circuit: Circuit) -> pd.DataFrame:
        circ = circuit.sonata_circuit
        ep = circ.edges[self.edge_population_name]
        ...
        indices = ep.pathway_edges(source=src_ids, target=tgt_ids)
