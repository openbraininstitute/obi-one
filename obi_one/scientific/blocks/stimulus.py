...
class HyperpolarizingCurrentClampSomaticStimulus(SomaticStimulus):
    ...
    class RelativeOrnsteinUhlenbeckCurrentSomaticStimulus(SomaticStimulus):
        """A current injection based on the Ornstein-Uhlenbeck process as a percentage of each cell's threshold current."""
    ...
    class RelativeOrnsteinUhlenbeckConductanceSomaticStimulus(SomaticStimulus):
        """A conductance injection based on the Ornstein-Uhlenbeck process as a percentage of each cell's input conductance (inverse of the input resistance)."""
        ...
        standard_deviation_percentage_of_cells_input_conductance: PositiveFloat | list[PositiveFloat] = Field(
            default=5.0,
            title="Standard Deviation",
