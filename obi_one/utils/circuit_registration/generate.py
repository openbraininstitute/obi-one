...
def generate_additional_circuit_assets(  # noqa: PLR0913
    circuit_path: Path,
    ...
    *,
    ...
    skip_compressed = not force and _entity_has_asset(
        circuit_entity, "compressed_sonata_circuit"
    )
    if skip_compressed:
        L.info(
    ...
    skip_matrices = not force and _entity_has_asset(
        circuit_entity, "circuit_connectivity_matrices"
    )
    matrix_config = None
    if skip_matrices:
        L.info(
