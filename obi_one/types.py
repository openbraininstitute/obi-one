...
class TaskType(StrEnum):
    ...
    aind_ephys_preprocessing = auto()
    aind_ephys_spikesorting = auto()
    ...
    aind_ephys_results_collector = auto()
    aind_ephys_processing_qc = auto()
    aind_ephys_qc_collector = auto()
    aind_ephys_cephys_nwb = auto()
    aind_ephys_units_nwb = auto()
