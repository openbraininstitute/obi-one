    ...
    def create_single_configs(self) -> list[SingleConfigMixin]:
        ...
        for idx, single_coordinate_scan_params in enumerate(self.coordinate_parameters()):
            ...
            try:
                ...
                single_coord_config.idx = idx  # ty:ignore[unresolved-attribute]
                single_coord_config.single_coordinate_scan_params = single_coordinate_scan_params  # ty:ignore[unresolved-attribute]
