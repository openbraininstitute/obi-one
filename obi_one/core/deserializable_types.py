...
TYPE_MAP: dict[str, str] = {
    ...
    "CreateExtracellularRecordingArrayScanConfig": "obi_one.scientific.tasks.create_recording_array",
    "CreateExtracellularRecordingArraySingleConfig": "obi_one.scientific.tasks.create_recording_array",
