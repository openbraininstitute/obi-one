...
TYPE_MAP: dict[str, str] = {
    ...
    "IonChannelFittingBetaScanConfig": "obi_one.scientific.tasks.ion_channel_modeling",
    "IonChannelFittingBetaSingleConfig": "obi_one.scientific.tasks.ion_channel_modeling",
