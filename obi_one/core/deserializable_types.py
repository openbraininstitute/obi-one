...
TYPE_MAP: dict[str, str] = {
    ...
    "CircuitSimulationScanConfig": "obi_one.scientific.tasks.generate_simulations.config.circuit",
    "CircuitSimulationSingleConfig": "obi_one.scientific.tasks.generate_simulations.config.circuit",
    ...
    "IonChannelModelSimulationScanConfig": "obi_one.scientific.tasks.generate_simulations.config.ion_channel_models",
    "IonChannelModelSimulationSingleConfig": "obi_one.scientific.tasks.generate_simulations.config.ion_channel_models",
    "MEModelSimulationScanConfig": "obi_one.scientific.tasks.generate_simulations.config.me_model",
    "MEModelSimulationSingleConfig": "obi_one.scientific.tasks.generate_simulations.config.me_model",
    "MEModelWithSynapsesCircuitSimulationScanConfig": "obi_one.scientific.tasks.generate_simulations.config.me_model_with_synapses",
    "MEModelWithSynapsesCircuitSimulationSingleConfig": "obi_one.scientific.tasks.generate_simulations.config.me_model_with_synapses",
