...
TYPE_MAP: dict[str, str] = {
    ...
    "EModelExportAndValidationScanConfig": "obi_one.scientific.tasks.emodel_building.task3_export_and_validation.config",
    "EModelExportAndValidationSingleConfig": "obi_one.scientific.tasks.emodel_building.task3_export_and_validation.config",
