...
3. Convert input spikes using [convert_input_spikes.ipynb](convert_input_spikes.ipynb)
...
4. Convert the simulations to sonata using [blue_config_sims_to_sonata.ipynb](blue_config_sims_to_sonata.ipynb). This:
    - Creates the sonata simulation configs
    - Remap output spikes to correct gids
